...
namespace MOD6_1302204046
{
    class GlossaryItem_1302204046
    {
        public GlossaryClass glossary { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_3_nim.json";

            string jsonString = File.ReadAllText(fileName);

            GlossaryItem_1302204046 jsonData = JsonSerializer.Deserialize<GlossaryItem_1302204046>(jsonString);
